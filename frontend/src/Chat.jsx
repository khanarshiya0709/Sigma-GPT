    ...
    return (
        <>
            ...
            <div className="chats" ref={chatContainerRef}>
                {/* 🔹 Upgraded Custom Audio Speech Bar */}

                {speechBar && (
                    <div className="speechBar">
                        {/* 🔹 Left: Play/Pause/Speaker Icon Circle */}
                        <div className="barPlayer">
                            <button
                                type="button"
                                className="speechControlBtn"
                                onClick={togglePauseResume}
                                title={isPaused ? "Play" : "Pause"}
                            >
                                <i className={isPaused ? "fa-solid fa-play" : "fa-solid fa-volume-high"}></i>
                            </button>
                            <span className="speechTime">{formatTime(currentTimeBar)}</span>
                        </div>

                        {/* 🔹 Center: Smooth Glowing Progress Bar */}
                        ...
                        {/* 🔹 Right: Total Duration + Clean Close Cross */}
                        <div className="speechRightActions">
                            <span className="speechTotalTime">{formatTime(totalTime)}</span>
                            <button
                                type="button"
                                className="speechCloseBtn"
                                onClick={stopSpeech}
                                title="Stop speech"
                            >
